...
## Step3. 질문 삭제하기 리팩토링 기능명세서

- [x] 일급컬렉션 적용
    - [x] Answers 추가
        - [x] 답변 추가의 validation 기능
        - [x] 답변들 삭제 기능 위임
    - [x] DeleteHistories 일급컬렉션 객체 추가
        - [x] 삭제이력 추가의 validation 기능
        - [x] 삭제이력은 변경되면 안되므로 unmodifiable 컬렉션으로 get
- [x] 삭제기능 도메인 클래스로 위임
    - [x] 답변 삭제
        - [x] 답변삭제 권한체크로직
        - [x] 답변삭제 후 삭제이력 생성
...
- [x] 테스트 코드 리팩토링
    - [x] 답변 삭제 테스트코드 작성
        - [x] 답변삭제 권한체크로직 테스트코드 작성
        - [x] 답변삭제 후 삭제이력 생성 테스트코드 작성
    - [x] 질문 삭제 테스트코드 작성
        - [x] 질문삭제 권한체크로직 테스트코드 작성
        - [x] 질문삭제 후 삭제이력 생성 테스트코드 작성
    - [x] public static 대신 private 파라미터를 사용하여 전체적인 테스트 인자의 독립성과 관리가능성을 높임
