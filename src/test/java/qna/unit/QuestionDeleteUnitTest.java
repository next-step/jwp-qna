...
public class QuestionDeleteUnitTest {
    ...
    @Test
    void 질문데이터_삭제는_데이터의_상태를_변경() throws Exception {
    ...
    @Test
    void 로그인사용자_질문사용자_동일해야_삭제가능() throws Exception {
    ...
    @Test
    void 질문사용자_모든답변의_답변자가_동일해야_삭제가능() throws Exception {
        assertThat(question.delete(UserTest.JAVAJIGI)).isNotNull();
    ...
    @Test
    void 질문삭제시_답변도삭제하며_답변도_데이터의_상태를_변경() throws Exception {
    ...
    @Test
    void 질문과답변_삭제이력은_내역을_관리() throws Exception {
