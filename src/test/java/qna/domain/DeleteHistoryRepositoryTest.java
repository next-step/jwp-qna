...
public class DeleteHistoryRepositoryTest {
    ...
    void update() {
        ...
        User u2 = new User("baek", "password", "name", "beck33@naver.com");
        actual.setUser(users.save(u2));

        assertThat(actual.getUser()).isNotEqualTo(u1);
        assertThat(actual.getUser()).isEqualTo(u2);
    }
