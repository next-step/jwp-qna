...
class QuestionRepositoryTest {
    ...
    void setUp() {
        ...
        user = userRepository.save(new User(new UserId("test1234"), new Password("1234"), new Name("테스트"), new Email("test1234@gmail.com")));
    }
    @Test
    ...
    void query_all_questions_test() {
        List<Question> questions =
            Arrays.asList(new Question(new Title("title1"), new Contents("contents1")).writeBy(user), new Question(new Title("title2"), new Contents("contents2")).writeBy(user));
    ...
    void update_question_title_test() {
        Question question = new Question(new Title("title2"), new Contents("contents2")).writeBy(user);
        Question saveQuestion = questionRepository.save(question);

        saveQuestion.changeTitle(new Title("테스트1"));
