...
public class QuestionRepositoryTest {
	...
	void save() {
		final Question expected = QuestionFixture.식별자가_userId인_유저가_작성한_질문("writer.id");
	...
	void findByDeletedFalse() {
		final Question question = saved(QuestionFixture.식별자가_userId인_유저가_작성한_질문("writer.id"));
	...
	void findByIdAndDeletedFalse() {
		final Question expected = saved(QuestionFixture.식별자가_userId인_유저가_작성한_질문("writer.id"));
