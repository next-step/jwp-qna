...
class UserRepositoryTest {
    ...
    void save_user_test() {
        User user = new User("javajigi", "password", new Name("name"), new Email("javajigi@slipp.net"));
    ...
    void query_user_by_user_id_test() {
        User savedUser = userRepository.save(new User("sanjigi", "password", new Name("name"), new Email("sanjigi@slipp.net")));
    ...
    void query_user_by_id_test() {
        User savedUser = userRepository.save(new User("javajigi", "password", new Name("name"), new Email("javajigi@slipp.net")));
    ...
    void change_user_name_test() {
        User javajigi = new User("test", "password", new Name("name"), new Email("javajigi@slipp.net"));
    ...
    void update_user_info_exception_test() {
        final User dummyUser = new User("testId", "2345", new Name("dummy"), new Email("dummy@example.com"));
    ...
    void delete_test() {
        User expected = userRepository.save(new User("testId123", "23a45", new Name("test"), new Email("test@test.com")));
    ...
    void duplicate_test() {
        User user = userRepository.save(new User("testId123", "23a45", new Name("test"), new Email("test@test.com")));

        assertThatThrownBy(() -> {
            final User newUser = new User(user.getUserId(), "1234", new Name("test"), new Email("test@gmail.com"));
