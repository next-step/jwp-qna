...
public class AnswerRepositoryTest {
    ...
    void save_user_test() {
        final Answer answer1 = AnswerTest.A1;
    ...
    void find_answer_by_question_id_test() {
        ...
        final Answer answer1 = answers.save(new Answer(writer, q1, "TEST1"));
        final Answer answer2 = answers.save(new Answer(writer, q1, "TEST2"));
        final Answer answer3 = answers.save(new Answer(writer, q2, "TEST3"));
    ...
    void find_not_deleted_answer_test() {
        ...
        final Answer answer1 = answers.save(new Answer(writer, q1, "TEST1"));
        final Answer answer2 = answers.save(new Answer(writer, q2, "TEST2"));
