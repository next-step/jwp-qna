...
public class QuestionTest {
    ...
    void 저장한_객체와_저장된_객체_비교() {
        Question question = new Question("gt", LocalDateTime.now(), false, "cheers", LocalDateTime.now(), 1L);
    ...
    void notNull_컬럼에_null을_저장() {
        Question question = new Question("gt", null, false, "cheers", LocalDateTime.now(), 1L);
