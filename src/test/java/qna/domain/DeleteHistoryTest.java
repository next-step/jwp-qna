...
class DeleteHistoryTest {
    ...
    @Test
    void 질문_삭제시_히스토리생성() {
        final DeleteHistory deleteHistory = DeleteHistory.questionDeleteHistory(QuestionTest.Q1);
        assertAll(() -> {
    ...
    void Answer_삭제시_히스토리생성() {
        final DeleteHistory deleteHistory = DeleteHistory.answerDeleteHistory(AnswerTest.A1);
        assertAll(() -> {
