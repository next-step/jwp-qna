...
public class DeleteHistoriesTest {
    ...
    void setUp() {
        ...
        deleteHistory1 = new DeleteHistory(ContentType.QUESTION, question.getId(), questionUser);
        deleteHistory2 = new DeleteHistory(ContentType.ANSWER, question.getId(), answerUser);
        deleteHistory3 = new DeleteHistory(ContentType.ANSWER, answer1.getId(), answerUser);
    ...
    void addHistory() {
        ...
        // then
        assertThat(deleteHistories.histories()).size().isEqualTo(3);
        assertThat(deleteHistories.histories()).containsAll(deleteHistoryList);
    }
