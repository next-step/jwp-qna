...
class QnaServiceTest {
    ...
    private void verifyDeleteHistories() {
        List<DeleteHistory> deleteHistories = Arrays.asList(
                new DeleteHistory(ContentType.QUESTION, question.getId(), userRepository.findById(question.getWriterId()).get(), LocalDateTime.now()),
                new DeleteHistory(ContentType.ANSWER, answer.getId(), userRepository.findById(question.getWriterId()).get(), LocalDateTime.now())
        );
