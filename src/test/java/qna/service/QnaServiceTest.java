...
class QnaServiceTest {
    ...
    public void setUp() throws Exception {
        question = QUESTION1(JAVAJIGI());
        answer = ANSWER1(JAVAJIGI(), question);
    ...
    public void delete_답변_중_다른_사람이_쓴_글() throws Exception {
        Answer answer2 = new Answer(2L, FixtureUtils.SANJIGI(), QUESTION1_WRITE_BY_JAVAJIGI(), "Answers Contents1");
