...
class QnaServiceTest {
    ...
    public void setUp() throws Exception {
        question = new Question(1L, "titleA", "contents1").writeBy(UserTest.JAVAJIGI);
    ...
    public void delete_답변_중_다른_사람이_쓴_글() throws Exception {
        Answer answer2 = new Answer(2L, UserTest.SANJIGI, QuestionTest.TITLEA_QUESTION, "Answers Contents1");
