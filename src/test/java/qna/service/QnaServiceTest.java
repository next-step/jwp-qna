...
class QnaServiceTest {
    ...
    public void delete_답변_중_다른_사람이_쓴_글() throws Exception {
        final Answer answer2 = new Answer(2L, UserTest.SANJIGI, QuestionTest.Q1, "Answers Contents1");
    ...
    private void verifyDeleteHistories() {
        final List<DeleteHistory> deleteHistories = Arrays.asList(
            new DeleteHistory(ContentType.QUESTION, question.getId(), UserTest.SANJIGI, LocalDateTime.now()),
            new DeleteHistory(ContentType.ANSWER, answer.getId(), UserTest.SANJIGI, LocalDateTime.now())
        );
