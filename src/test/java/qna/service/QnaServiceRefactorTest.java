...
class QnaServiceRefactorTest {
    ...
    public void delete_성공() throws Exception {
        ...
        qnaService.deleteQuestion_refactor(UserTest.JAVAJIGI, question.getId());
    ...
    public void delete_다른_사람이_쓴_글() throws Exception {
        ...
        assertThatThrownBy(() -> qnaService.deleteQuestion_refactor(UserTest.SANJIGI, question.getId()))
    ...
    public void delete_답변_중_다른_사람이_쓴_글() throws Exception {
        ...
        assertThatThrownBy(() -> qnaService.deleteQuestion_refactor(UserTest.JAVAJIGI, question.getId()))
                .isInstanceOf(CannotDeleteException.class);
    }
