...
public class DeleteHistory {
    ...
    public static DeleteHistory createAnswerDeleteHistory(Long contentId, User deletedByUser) {
        return new DeleteHistory(ContentType.ANSWER, contentId, deletedByUser, LocalDateTime.now());
    }
